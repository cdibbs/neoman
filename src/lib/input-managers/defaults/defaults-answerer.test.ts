...
import { ITemplateComplexInput } from "../../user-extensibility";
...
export class DefaultsAnswererTests {
    ...
    getDefault_returnsDefaultWhenAvailable(): void {
        var answer = this.answerer.getDefault(<ITemplateComplexInput>{ default: 321 });
    ...
    getDefault_noTemplateDefault_returnsGeneratedDefault(val: string | ITemplateComplexInput): void {
