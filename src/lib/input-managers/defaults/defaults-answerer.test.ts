...
export class DefaultsAnswererTests {
    ...
    getDefault_returnsDefaultWhenAvailable(): void {
        var answer = this.answerer.getDefault(<ITemplateTypedInput>{ default: 321 });
    ...
    getDefault_noTemplateDefault_returnsGeneratedDefault(val: string | ITemplateTypedInput): void {
